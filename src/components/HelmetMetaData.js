...
export default function HelmetMetaData(props) {
    ...
    let currentUrl = "https://delicate-beignet-5f898e.netlify.app" + location.pathname;
    let quote = props.quote !== undefined ? props.quote : "";
    let title = props.title !== undefined ? props.title : "CampersTribe - World is yours to explore";
    let image = props.image !== undefined ? props.image : "https://delicate-beignet-5f898e.netlify.app/images/cover/cover.jpg";
    ...
    return (
        <Helmet>
            ...
            <meta property="og:image" content="%PUBLIC_URL%/images/cover/cover.jpg" />

            <meta name="twitter:card" content="summary_large_image" />
            <meta property="twitter:domain" content="delicate-beignet-5f898e.netlify.app" />
            <meta property="twitter:url" content="https://delicate-beignet-5f898e.netlify.app/think/en" />
            <meta name="twitter:title" content="SUFFIX Digital Strategy & Execution" />
